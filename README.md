...
- 'ChessGame' - 고수준, 겍체지향적으로 만들어져 사용하기 편합니다.
- 'Chessboard' - 저수준 비트보드로 만들어져 성능이 중요한 프로젝트 (엔진 개발 등) 에 사용됩니다.

*아래 벤치마크 결과는 Apple M5 칩, 싱글스레드 기준, JIT warmup 을 한 결과입니다.*
...
|----------|-------------|-------------|
| 1 스레드 | 2.53MNPS    | 2.68MNPS    |
| 2 스레드 | 4.40MNPS    | 4.46MNPS    |
| 4 스레드 | 6.30MNPS    | 6.04MNPS    |

#### Perft 'Chessboard' 기준

| 스레드   | NPS (6 ply) | NPS (7 ply) |
|----------|-------------|-------------|
| 1 스레드 | 65.03MNPS   | 62.96MNPS   |
| 2 스레드 | 108.85MNPS  | 112.54MNPS  |
| 4 스레드 | 142.16MNPS  | 185.56MNPS  |
