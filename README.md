...
*아래 벤치마크 결과는 Apple M5 칩, 싱글스레드 기준,
...
|----------|-------------|-------------|
| 1 스레드 | 6.91MNPS    | 7.40MNPS    |
| 2 스레드 | 13.52MNPS   | 13.32MNPS   |
| 4 스레드 | 22.52MNPS   | 21.62MNPS   |

#### Perft `Chessboard` 기준

| 스레드   | NPS (6 ply) | NPS (7 ply) |
|----------|-------------|-------------|
| 1 스레드 | 63.77MNPS   | 60.51MNPS   |
| 2 스레드 | 110.12MNPS  | 97.55MNPS   |
| 4 스레드 | 139.20MNPS  | 125.68MNPS  |
