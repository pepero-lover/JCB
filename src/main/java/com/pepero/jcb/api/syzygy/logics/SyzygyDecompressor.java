...
public class SyzygyDecompressor {
     ...
     */
    public static int decompressPairs(byte[] data, SyzygyBlockLayout.Entry entry,
        ...
        // for a leaf, byte 0 of its 3-byte record IS the actual stored value
        // (for WDL tables specifically, this is the WDL result code 0~4)
        return symPat[3 * sym] & 0xff;
    }
}